<?php
/* Smarty version 3.1.31, created on 2020-04-06 15:57:14
  from "/home/u578573205/domains/vosikola.com/public_html/view/index.tpl" */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '3.1.31',
  'unifunc' => 'content_5e8b434a0c5223_17343858',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '8e9aa343cd80d5b5c0f44755ad54d3a22b3ff98c' => 
    array (
      0 => '/home/u578573205/domains/vosikola.com/public_html/view/index.tpl',
      1 => 1586184887,
      2 => 'file',
    ),
  ),
...
function content_5e8b434a0c5223_17343858 (Smarty_Internal_Template $_smarty_tpl) {
?>
<!DOCTYPE html>
<html lang="pt">
    <head>
...
/tema/css/script.css" rel="stylesheet" type="text/css">  
    ...
    <body id="page-top">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#services">Sobre nós</a></li>
            ...
            <div class="container h-100">
                <div class="row h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-10 align-self-end">
                        <h1 class="text-uppercase text-white font-weight-bold">SISTEMA INTEGRADO DE GESTÃO ESCOLAR</h1>
                        <hr class="divider my-4" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 font-weight-light mb-5">O <strong>V-OSIKOLA</strong>, é um Sistema versátil, ideal para a Gestão Escolar no domínio Pedagógico, Administrativo e Financeiro. 
        ...
        <section class="page-section bg-primary" id="about">
            <div class="row maior">
                <div class="login-container">
                    ...
                    <div class="form-box">
                        <form class="form" name="login" method="post" action="">
                            ...
                            <button class="btn btn-dark btn- btn-block btn-lg" name="txt_logar" id="txt_logar" value="txt_logar">Entrar
                            </button>
                        </form>
                    </div>
                ...
                <!--div class="col-lg-8 text-center">
                    <h2 class="text-white mt-0">Uma nova forma de encarar o Sistema de Ensino/Aprendizagem</h2>
                    <hr class="divider light my-4" />
                    <p class="text-white-50 mb-4">O <strong>V-OSIKOLA</strong>, é um Sistema versátil, ideal para a Gestão Escolar no domínio Pedagógico, Administrativo e Financeiro. 
                        Atende os Subsistemas do Ensino Geral, Formação de Professores, Técnico Profissional do Sistema de Educação Angolado. 
                        Está disponivel em versões Mobile(Smartphones, Tablets, Ipads), PC, MAC e Web.</p>
        ...
        <section class="page-section" id="services">
            <div class="container">
                <h2 class="text-center mt-0">Uma nova forma de encarar o Sistema de Ensino/Aprendizagem</h2>
                <hr class="divider my-4" />
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            ...
                            <p class="text-muted mb-0">Podem monotorar em tempo real a execução dos trabalhos de seus funcionários, estabelecer prazos e autorizações para tarefas específicas</p>
                        </div>
                    </div>
                </div>
            </div>
...
" alt="" />
        ...
        <footer class="bg-light py-5">
            <div class="container">
                <div class="small text-center text-muted">Copyright © <?php echo '<script'; ?>
