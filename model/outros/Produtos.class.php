...
Class Produtos extends Conexao {
    ...
    function GetProdutos() {
        ...
        $query = "SELECT * FROM {$this->tabela}produtos p INNER JOIN {$this->prefix}categorias c ON p.pro_categoria = c.cate_id";
    ...
    function Alterar($id) {
        ...
        // executo a SQL
        if ($this->ExecutaSQL($query, $params)):
