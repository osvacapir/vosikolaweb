        ...
        <div class="login-container">
            ...
            <div class="form-box">
                ...
                <form name="login" method="post" action="">
                    <input name="txt_email" type="text" placeholder="Usuário">
                    <input type="password" placeholder="password" name="txt_senha">
                    {$SMS_ERRO}
            ...
            <center>
                <!--button class="btn btn-warning" data-toggle="collapse" data-target="#recovery"> Esqueceu a senha? </button-->

                <a href="{$HOME}" class="btn btn-info"> Voltar a página Principal </a>
            </center>
