         <!-- Sidebar - Brand -->
            ...
            <!-- Nav Item - Pages Collapse MenuAvançado -->
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#menuAvan" aria-expanded="true" aria-controls="menuAvan">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Definições Avançadas</span>
                </a>
                <div id="menuAvan" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Custom Components:</h6>
                        <a class="collapse-item" href="{$PAG_CATEGORIAS}">Categoria</a>
            ...
            <li class="nav-item">
                ...
                <div id="menuPedT" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{$PAG_CURRICUL}">Curriculo</a>
                        <a class="collapse-item" href="{$PAG_CURSOS}">Cursos</a>
                        <a class="collapse-item" href="{$PAG_DECLARAC_NOT}">Declaração Notas</a>
                        <a class="collapse-item" href="{$PAG_DISCIPLIN}">Disciplinas</a>
