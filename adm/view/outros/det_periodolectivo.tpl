<P>Período lectivo {$COD}</P>

<hr>

<div class="card-header py-3">
    {$SMS_ERRO}
    <form name="periodlectiv_insere=" class="form-inline" action="" method="post"> 
        <div class="row">

            <div class="col-md-2">
                <input class="form-control ml-1" required="required" type="text" value="{$DESIGNACAO}" name="Designacao" placeholder="Designação"/>
            </div>
